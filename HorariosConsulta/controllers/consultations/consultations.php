<?php 
    ...
    $query = "select m.nombre matNombre ,u.nombre profNombre, u.apellido, u.email, u.id profId, c.esVirtual,c.id,c.dia,c.horaInicio,c.horaFin,c.cupo,c.cancelado,c.horaInicioEspecial,c.horaFinEspecial,c.fechaEspecial
    from materias m
